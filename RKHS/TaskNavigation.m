classdef TaskNavigation<Task
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskNavigation(state)
            % constructor
            obj = obj@Task(state);
            obj.currentReward = 0;
        end
        ...
        function taskparams=init(obj) %#ok<MANU>
            ...
            taskparams.environment.area.limits = [-4 4 -4 4 -20 0];
        ...
        function r=reward(obj)
            ...
            %          r - the reward
            %
            e = obj.simState.platforms{1}.getX(1:3)-obj.goal(1:3)';
            r = exp(-(e' * e));
